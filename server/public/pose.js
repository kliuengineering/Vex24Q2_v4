/************************************** SETUP BEGINS ***************************************/
// IPADDRESS set-up here:
let IPAdress = "10.38.67.212";
...
function onResultsPose(results) {
  ...
  document.getElementById(
    "actionValue"
  ).innerText = `Agent's current action is -> ${action}`;
  ...
  document.getElementById(
    "leftArmAnglePrint"
  ).innerText = `Your left arm angle is -> ${leftArmAngle.toString()}`;
  document.getElementById(
    "rightArmAnglePrint"
  ).innerText = `Your right arm angle is -> ${rightArmAngle.toString()}`;
